    ...
    className="flex flex-col gap-5 mt-2 ">
      <div className={`${lightMode ? "bg-white/80 shadow-md": "bg-gray-800"} p-4 w-[80%] m-auto`} >
        ...
        <div className="grid grid-cols-3 gap-25">
          ...
          <div className="text-white p-1 bg-green-400 text-center rounded-md font-medium cursor-pointer my-1">Link</div>
          <div className="text-white p-1 bg-[#ff5733] text-center rounded-md font-medium cursor-pointer my-1 ">Unlink</div>
        </div>
        <div className="grid grid-cols-3 gap-25">
      ...
      <div className={`${lightMode ? "bg-white/80 shadow-md" :"bg-gray-800"} p-4 w-[80%] m-auto`}>
        ...
        <form className="flex flex-col gap-4">
          ...
          <input className={`${lightMode ? "text-gray-600 border-gray-400":"text-white border-white/30 focus:border-[cyan]"} border  p-2 w-[80%] m-auto outline-none `} type="email" autoComplete="off" placeholder="New email"/>
          <input className={`text-green-400 font-bold border  p-2 ${lightMode ? "bg-purple-700 border-purple-700 text-gray-600 " : "bg-gray-600 border-white/30"} cursor-pointer w-1/2 m-auto`} type="submit" value={"Save"}/>
        </form>
      </div>
      ...
      <p className={`${lightMode? "text-gray-600" : "text-white"} text-center font-bold mb-2`}>Change password</p>
        <form className="flex flex-col gap-4">
          <input className={`${lightMode ? "text-gray-600 border-gray-400":"text-white border-white/30 focus:border-[cyan]"} border  p-2 w-[80%] m-auto outline-none `} type="email" autoComplete="off" placeholder="You active email..."/>
          <input className={`${lightMode ? "text-gray-600 border-gray-400":"text-white border-white/30 focus:border-[cyan]"} border  p-2 w-[80%] m-auto outline-none `} type="password" placeholder="New password..."/>
          <input className={`${lightMode ? "text-gray-600 border-gray-400":"text-white border-white/30 focus:border-[cyan]"} border  p-2 w-[80%] m-auto outline-none `} type="password" placeholder="Confirm password..."/>
          <input className={`text-green-400 font-bold border  p-2 ${lightMode ? "bg-purple-700 border-purple-700 text-gray-600 " : "bg-gray-600 border-white/30"} cursor-pointer w-1/2 m-auto`} type="submit" value={"Update password"}/>
        </form>
      </div>
      ...
      <div className={`${lightMode ? "bg-white/80 shadow-md": "bg-gray-800"} p-4 w-[80%] m-auto mb-5`}>
