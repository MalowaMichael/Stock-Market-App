...
export const LoginSignup = () =>{
  ...
  return (
    ...
    className="p-2 md:p-0 border-none border-white md:w-[94%] m-auto h-screen">
      <form action="" className="flex flex-col gap-5 mt-8">

        <p className={`${lightMode ? "text-purple-700":"text-[cyan]"} md:ml-22 text-2xl md:text-4xl font-bold `}>        
          {isLogin ? "Good to see you again" : "Step into the future"}
      </p>
        {!isLogin && (
          
          <div className="relative group w-[100%] md:w-[80%] m-auto ">
        ...
        <div className=" w-4/5 md:w-1/2 m-auto my-2">
