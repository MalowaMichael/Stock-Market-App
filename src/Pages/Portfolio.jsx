    ...
    className="border-none border-white min-h-screen w-[94%] m-auto overflow-y-auto">
        ...
        className="flex flex-col gap-15">
          <div className="border-none border-white">
            <p className={`${lightMode ? "text-purple-700" : "text-[cyan]"} text-3xl font-bold py-4`}>Stocks in Watchlist</p>
            <div id="watchlist" className=" overflow-y-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-5">
          ...
          <div id="other stocks" className="border-none border-white overflow-y-auto">
            <p className={`${lightMode ? "text-purple-700" : "text-[cyan]"} text-3xl font-bold py-4`}>More in market</p>
        ...
        {subTabSelected === "News" && (
          ...
          <div className={`${lightMode ? "bg-white/80 shadow-md" : "bg-gray-800"} p-2 border-none border-green-400 h-[40vh]`}>
