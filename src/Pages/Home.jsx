...
//if (stocks.length === 0) return <p>Loading stocks...</p>;
    ...
    className="flex flex-col gap-2 border-none border-white overflow-y-auto mt-4 -z-10">
        
            

            <div id="indices" className="grid grid-cols-4 gap-5 border-none border-white w-[94%] m-auto overflow-x-auto">
                ...
                <div id = "chart-calender" className="flex justify-between gap-4 w-[94%] m-auto mt-2 border-none border-white h-[50vh]">
                    <div className="w-[70%] border-none border-white cursor-pointer">
                       <Link to={'/fullcharts'}>
                    ...
                    <div className="w-[30%] border-none border-white overflow-y-auto">
            ...
            <div id="wishlist-news" className="flex items-start justify-between gap-5 border-none border-white mt-2 w-[94%] m-auto">
                
                <div id="watchlist" className="w-[70%] h-[40vh] border-none border-white bg-[transparent]  m-auto overflow-y-auto ">
                ...
                <div id="recent-news" className={` ${lightMode ? "bg-white/80" : "bg-gray-800"} p-2 w-[30%] h-[40vh] overflow-y-auto`}>
